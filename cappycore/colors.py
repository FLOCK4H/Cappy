...
def iprint(string):
    print(f'{ColorCodes.BRIGHT}{ColorCodes.GREEN}[{ColorCodes.ORANGE}CAPPY{ColorCodes.GREEN}]{ColorCodes.RESET}' + ' ' + f'{ColorCodes.WHITE}{ColorCodes.BRIGHT}{string}{ColorCodes.BRIGHT}{ColorCodes.RESET} ')

def oneline(string, sys, color=ColorCodes.GREEN):
    sys.stdout.write(f'\r{ColorCodes.GREEN}[{ColorCodes.ORANGE}CAPPY{ColorCodes.GREEN}]{ColorCodes.RESET}' + ' ' + f"{color}{ColorCodes.BRIGHT}{string}{ColorCodes.RESET}")
    sys.stdout.flush()
